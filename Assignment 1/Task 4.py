...
output_string_wavefunction = f'\output\A1_Task3_hydrogen_wavefunction_N={N}.csv'  
with open(current_absolute_path+output_string_wavefunction,'w') as CSV_file:
...
output_string_energy = f'\output\A1_Task3_hydrogen_energy_N={N}.txt'  
with open(current_absolute_path+output_string_energy,'w') as file:
